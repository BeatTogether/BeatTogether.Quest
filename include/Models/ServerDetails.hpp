...
DECLARE_JSON_CLASS(ServerDetails,
                    NAMED_VALUE_DEFAULT(std::string, serverName, "", "ServerName");
                    NAMED_VALUE_DEFAULT(std::string, hostName, "", "HostName");
                    NAMED_VALUE_DEFAULT(int, port, 2328, "Port");
                    NAMED_VALUE_DEFAULT(std::string, statusURI, "", "StatusUri");
