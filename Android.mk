...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"BeatTogether"' -DVERSION='"0.2.0"' -DHOST_NAME='"btogether.xn--9o8hpe.ws"' -DPORT='2328' -I'./shared' -I'./extern' -isystem'./extern/codegen/include'
