...
Compress-Archive -Path "./libs/arm64-v8a/libbeattogether.so", "./libs/arm64-v8a/libbeatsaber-hook_0_8_4.so", "./Cover.png", "./bmbfmod.json" -DestinationPath "./BeatTogether_v$VERSION.zip" -Update
